; Listing generated by Microsoft (R) Optimizing Compiler Version 19.00.24210.0 
	...
	TITLE	C:\Users\yanshuyu\Documents\Visual Studio 2015\Projects\Collection\3party\zlib-1.2.8\uncompr.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
; File c:\users\yanshuyu\documents\visual studio 2015\projects\collection\3party\zlib-1.2.8\uncompr.c
_TEXT	SEGMENT
_stream$ = -60						; size = 56
_err$ = -4						; size = 4
_dest$ = 8						; size = 4
