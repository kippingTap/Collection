; Listing generated by Microsoft (R) Optimizing Compiler Version 19.00.24210.0 
	...
	TITLE	C:\Users\yanshuyu\Documents\Visual Studio 2015\Projects\Collection\3party\zlib-1.2.8\inftrees.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
; File c:\users\yanshuyu\documents\visual studio 2015\projects\collection\3party\zlib-1.2.8\inftrees.c
_TEXT	SEGMENT
_offs$ = -148						; size = 32
_count$ = -116						; size = 32
_mask$ = -84						; size = 4
